...
public class FillTheBlankQuestionAddController {
    ...
    void onAddButtonClicked(MouseEvent event) throws IOException, URISyntaxException {
        ...
        FillBlank q = new FillBlank(questionTitle, LandingPageController.userID, language, difficulty);
        ...
        idMap.put("Medium", "M");
        idMap.put("Hard", "H");
        q.setId("FB" + idMap.get(language) + idMap.get(difficulty) + Main.server.getTotalQuestionCount());
        ...
        Main.server.addFillBlankQuestion(q);
