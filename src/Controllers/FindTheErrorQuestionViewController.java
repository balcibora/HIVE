...
public class FindTheErrorQuestionViewController implements Initializable {
    ...
    void onButtonSaveClicked(MouseEvent event) throws IOException, URISyntaxException {
        ...
        Main.server.addFindErrorQuestion(question);
    ...
    public void setData(String questionID2) throws IOException, URISyntaxException {
        question = Main.server.getFEQuestion(questionID2);
