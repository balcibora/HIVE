...
public class FillTheBlankQuestionViewController implements Initializable{
    ...
    void onButtonSaveClicked(MouseEvent event) throws IOException, URISyntaxException {
        ...
        Main.server.addFillBlankQuestion(question);
    ...
    public void setData(String questionID2) throws IOException, URISyntaxException {;
        question = Main.server.getFTBQuestion(questionID2);
