...
public class TracingQuestionAddController {
    ...
    void onAddButtonClicked(MouseEvent event) throws IOException, URISyntaxException {
        ...
        TraceCode q = new TraceCode(questionTitle, LandingPageController.userID, language, difficulty);
        ...
        idMap.put("Medium", "M");
        idMap.put("Hard", "H");
        q.setId("TC" + idMap.get(language) + idMap.get(difficulty) + Main.server.getTotalQuestionCount());
        ...
        Main.server.addTraceCodeQuestion(q);
